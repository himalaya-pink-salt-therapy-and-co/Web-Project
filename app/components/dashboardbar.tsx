...
export default function DashboardBar() {
  ...
  return (
    <>
      ...
      {/* Sidebar Drawer */}
      <aside 
        className={`w-64 bg-white border-r border-zinc-200 h-screen fixed md:sticky top-0 left-0 z-50 flex flex-col shadow-xl md:shadow-sm shrink-0 transition-transform duration-300 ease-in-out ${
